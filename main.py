...
def show_start_interface(screen, width, height):
	bg_img = pygame.image.load("./images/others/background.jpg")
	screen.blit(bg_img, (0, 0))
	tfont = pygame.font.Font('./font/simkai.ttf', width//7)
	cfont = pygame.font.Font('./font/simkai.ttf', width//20)
	title = tfont.render(u'Battle City', True, (0, 0, 0))
	content1 = cfont.render(u'1 player ', True, (255, 255, 255))
	content2 = cfont.render(u'2 players', True, (255, 255, 255))
...
def show_end_interface(screen, width, height, is_win):
	if is_win:
		bg_img = pygame.image.load("./images/others/win.jpg")
		screen.blit(bg_img, (0, 0))
		...
		bg_img = pygame.image.load("./images/others/loss.jpg")
		screen.blit(bg_img, (0, 0))
...
def show_switch_stage(screen, width, height, stage):
	...
	screen.blit(bg_img, (0, 0))
	font = pygame.font.Font('./font/simkai.ttf', width//10)
	content = font.render(u'Round %d' % stage, True, (255, 255, 255))
	rect = content.get_rect()
